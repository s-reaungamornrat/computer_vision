...
parser.add_argument('--lr', default=0.01, type=float, help='initial learning rate. In torchvision.references, this was set to 0.64')
parser.add_argument('--lrf', default=0.01, type=float, help='final LR fraction; final LR = lr0 * lrf')
parser.add_argument('--momentum', default=0.937, type=float, help='momentum', metavar='M')
...
parser.add_argument('--warmup-epochs', default=6, type=int, help='the number of epochs to warmup (default:10)')
